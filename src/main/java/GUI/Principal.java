...
public class Principal extends javax.swing.JFrame {
    ...
    public GraphMA initializeGraph(List<User> users, List<int []> relations){
        ...
        for (int i =0;i<relations.getSize();i++){
            ...
            int x = getXComponent(users, relations,idx);
            int y = getYComponent(users,relations,idy);
            graph.insertArista(x,y,(relations.accessElement(i))[2]);
        }
